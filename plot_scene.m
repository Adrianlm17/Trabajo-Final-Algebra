function plot_scene(surface_points, sun_point, shadows, plane_coefficients, No)
  ...
  hold on;
  scatter3(sun_point(1), sun_point(2), sun_point(3), "r");
  hold on;
  ...
  if No == 1
    title ("Gráfico de la escena (Luz 1)");
  else
    title ("Gráfico de la escena (Luz 2)");
  endif
endfunction
